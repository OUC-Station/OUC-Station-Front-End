...
[
    //二五广场
    {
      ...
      info:'二五广场位于西门正前方，因其两侧为第二和第五教学区，得名为“二五广场”。二五广场二五广场场地宽阔，需要较大空间的校园活动往往会在这里举行。',     
    ...
    //二餐
      {
        ...
        info:'第二食堂有两层。一层食物中规中矩吧，不太推荐这里的自选菜，性价比稍微低一点。二层风味餐厅有更多选择，麻辣烫、麻辣香锅、烤鱼、黄焖鸡、湖南菜、米粉、旋转小火锅等等，味道还可以价格也比较美丽。温馨提示一下，这里的奶茶有点甜腻，更推荐果茶。',     
       ...
       //一餐
       {
        ...
        //图书馆
        {
         ...
         //西门
         {
          ...
          info:'中国海洋大学崂山校区(西北门)公交站：海大崂山校区、海大崂山校园、海大崂山校区、海大崂山停车场、海大路、北龙口西、海大路、恒星学院、北龙口、北龙口、恒星学院、北龙口 附近的公交车：110路、125路、311路、381路、383路、384路环线、385路、386路环线、387路、388路环线、617路、619路、世园快线2路、世园专线5路、382路环线、628路、世园专线7路、113路区间、113路、112路区间、112路、326路、361路、365路',     
          iconPath: "../../images/circle.png",
